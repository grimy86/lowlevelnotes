# Data collections
In C#, data collections are used to store and manage `multiple values in a single structure`. Each type of collection serves a unique purpose, depending on how you want to manage, access, 
and modify the data.
